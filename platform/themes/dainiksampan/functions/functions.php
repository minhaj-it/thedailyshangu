...
app()->booted(function (): void {
    RvMedia::addSize('featured', 560, 315)
        ->addSize('medium', 330, 186);
    ...
    Theme::typography()
        ...
        ->registerFontSizes([
            ...
            new TypographyItem('body', __('Body'), 18),
        ]);
...
Menu::addMenuLocation('category-menu', __('Second menu'));
    app('events')->listen(RenderingWidgetSettings::class, function (): void {
        ...
        register_sidebar([
        'id'          => 'ads-1',
        'name'        => __('Right Side Ads-1  '),
        'description' => __('This is top sidebar section'),
        ]);
         register_sidebar([
        'id'          => 'ads-2',
        'name'        => __('Categoy Right Side Ads-2  '),
        'description' => __('This is top sidebar section'),
        ]);
         register_sidebar([
        'id'          => 'center-ads-4',
        'name'        => __('Category Center Ads-4  '),
        'description' => __('This is top sidebar section'),
        ]);
         register_sidebar([
        'id'          => 'popular-tag',
        'name'        => __('Tag Show  '),
        'description' => __('Popular Tag'),
        ]);

        register_sidebar([
        'id'          => 'center-ads-1',
        'name'        => __('Center Ads-1  '),
        'description' => __('This is top sidebar section'),
        ]);
        register_sidebar([
        'id'          => 'center-ads-2',
        'name'        => __('Center Ads-2  '),
        'description' => __('This is top sidebar section'),
        ]);
        register_sidebar([
        'id'          => 'center-ads-3',
        'name'        => __('Center Ads-3  '),
        'description' => __('This is top sidebar section'),
        ]);
