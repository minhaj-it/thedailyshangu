 @php
    ...
    if (is_plugin_active('blog')) {
        ...
        /**
         * A reusable function to get category details and its posts WITHOUT caching.
         * @param int $categoryId
         * @param int $limit
         * @return object { category: ?object, posts: Collection }
         */
        $getPostsForCategory = function(int $categoryId, int $limit) use ($categoryRepo, $postRepo) {
        ...
        $topNewsData = $getPostsForCategory(28, 8);
        $nationalData = $getPostsForCategory(12, 5); // *** ok ***
        $countrywideData = $getPostsForCategory(9, 7); // *** ok ***
        $politicsData = $getPostsForCategory(16, 5); // *** ok ***
        $sportsData = $getPostsForCategory(24, 5);  // *** ok ***
        $simpleOneData = $getPostsForCategory(24, 3);  // *** ok ***
        $entertainmentData = $getPostsForCategory(15, 7); // *** ok ***
        $simpleTwoData = $getPostsForCategory(14, 4); // *** ok ***
        $hillData = $getPostsForCategory(17, 5);
        $businessData = $getPostsForCategory(17, 5);
        // Data for right columns or special sections
        $opinionData = $getPostsForCategory(9, 8); // *** Change 20 to your 'মতামত' category ID ***
        $educationData = $getPostsForCategory(13, 3); 
        $jobsRightData = $getPostsForCategory(18, 3);
    }
@endphp
...
<main class="container py-3">
        <!-- Ad Banner -->
        <div class="ad-banner text-center mb-3">
           {!! dynamic_sidebar('center-ads-1') !!}
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-9">
                           @php
                                ...
                                $posts = $uniqueSortedPosts->merge($regularPosts)->take(4);
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="title-cover">
                                                    <h1>{{ $posts[0]->name }}</h1>
                                                    <p> {{ Str::limit($posts[0]->description, 80) }} </p>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="img-cover">
                                    ...
                                    <div class="d-flex flex-column gap-3 semi-top">
                                        ...
                                        <div class="semi-news d-flex lat-tab gap-2 pb-2">
                                            ...
                                            <div class="img-hover-zoom-tb">
                                                <a href="{{ $post->url }}">
                                                    <img src="{{ RvMedia::getImageUrl($post->image, 'medium', false, RvMedia::getDefaultImage()) }}" class="img-fluid fixed-img " alt="{{ $post->name }}">
                                                </a>
                                            </div>
                                        </div>
                                        @endforeach
                    ...
                    <div class="row mini-card-0">
                         @if ($topNewsData->category && $topNewsData->posts->isNotEmpty())
                         @foreach ($topNewsData->posts as $post)
                            <!-- News Item -->
                ...
                <div class="col-md-3 border-left ">
                    ...
                    <div class="tabnews-area">
                        ...
                        <ul class="nav nav-tabs justify-content-center nav-justified" id="newsTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="popular-tab" data-bs-toggle="tab" data-bs-target="#popular" type="button" role="tab" aria-controls="popular" aria-selected="false">জনপ্রিয় সংবাদ</button>
                            </li>
                        </ul>

                        <!-- Tab Content -->
                        <div class="tab-content  border-top-0 pt-2" id="newsTabContent">
                            <!-- সর্বশেষ -->
                            <div class="tab-pane fade show active" id="latest" role="tabpanel" aria-labelledby="latest-tab">
                                <div class="d-flex flex-column gap-3">
                                    @foreach (get_latest_posts(4, []) as $post)
                                    <div class="d-flex lat-tab gap-2 border-bottom-pro pb-2">
                                        <div class="img-hover-zoom-tb">
                                            <img src="{{ RvMedia::getImageUrl($post->image, 'medium', false, RvMedia::getDefaultImage()) }}" class="img-fluid fixed-img " alt="{{ $post->name }}">
                                        </div>
                                        <div class="flex-grow-text ">
        ...
        <section class="cat-four">
            <div class="row">
                <!-- left col-9 -->
                <div class="col-lg-9">
                    @if ($nationalData->category && $nationalData->posts->isNotEmpty())
                    <div class="opinion-section">
                        <h4><a href="{{ $nationalData->category->url }}"> {{ $nationalData->category->name }} </a></h4>
                    </div>
                     <div class="row">
                         @php $firstPost = $nationalData->posts->first(); @endphp
                            @if ($firstPost)
                            <div class="col-lg-6">
                                <div class="bg-cat-news card mb-3">
                                    <a href="#">
                                        <div class="cate-two-zoom5">
                                            <img class="img-fluid" src="{{ RvMedia::getImageUrl($firstPost->image, 'featured', false, RvMedia::getDefaultImage()) }}" alt="{{ $firstPost->name }}" alt="">
                                        </div>
                                        <h4 class="pt-3 comtitle">{{ $firstPost->name }}  </h4>
                                        <p> {{ Str::limit($firstPost->description, 130) }} </p>
                                    </a>
                                </div>
                            </div>
                         @endif
                        ...
                        <div class="col-lg-6">
                             @foreach ($nationalData->posts->skip(1) as $post)
                                    ...
                                    <div class="card-body d-flex gap-3 align-items-center">
                                        <a href="{{ $post->url }}">
                                            <div class="cate-two-zoom6">
                                                <img src="{{ RvMedia::getImageUrl($post->image, 'medium', false, RvMedia::getDefaultImage()) }}" class="" alt="Adviser">
                                            </div>
                                        </a>
                ...
                <!-- right Side -->
                 <div class="col-lg-3">
                   <div class="box-title mt-4"> <h4>আপনার বিভাগের খবর</h3> </div>
                   <div class="borderC1-1 borderRadius5 padding20">
					<div class="homePageSideSvg">
                        ...
                        .st1{fill:#80C2EB;}
                        .st2{fill:none;}
                        .st3{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st4{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st5{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st6{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st7{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st8{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st9{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st10{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st11{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}

                        .st13{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.25;stroke-miterlimit:10;}
                        .st14{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st15{fill:#017AC3;stroke:#FFFFFF;stroke-width:0.25;stroke-miterlimit:10;}
                        .st16{enable-background:new    ;}
                        .st17{fill:#FFFFFF;}
                        .st18{opacity:0.34;}
                        .st19{fill:#D5D5D5;}

                        #rangpur:hover path{fill:#00446d;}
                        #rangpur:hover path.st17{fill:#fff;}
                        #rangpur:hover path.st19{fill:#d5d5d5;}

                        #mymensingh:hover path{fill:#00446d;}
                        #mymensingh:hover path.st17{fill:#fff;}
                        #mymensingh:hover path.st19{fill:#d5d5d5;}

                        #sylhet:hover path{fill: #00446d;}
                        #sylhet:hover path.st17{fill:#fff;}
                        #sylhet:hover path.st19{fill:#d5d5d5;}

                        #rajshahi:hover path{fill: #00446d;}
                        #rajshahi:hover path.st17{fill:#fff;}
                        #rajshahi:hover path.st19{fill:#d5d5d5;}

                        #khulna:hover path{fill: #00446d;}
                        #khulna:hover path.st17{fill:#fff;}
                        #khulna:hover path.st19{fill:#d5d5d5;}

                        #borishal:hover path{fill: #00446d;}
                        #borishal:hover path.st17{fill:#fff;}
                        #borishal:hover path.st19{fill:#d5d5d5;}

                        #chittagong:hover path{fill: #00446d;}
                        #chittagong:hover path.st17{fill:#fff;}
                        #chittagong:hover path.st19{fill:#d5d5d5;}

                        #dhaka:hover path{fill: #00446d;}
                        ...
                        <g id="rangpur">
                        <a href="https://dainiksampan.com/rangpur" xlink:href="https://dainiksampan.com/rangpur">
                        ...
                        T9s7szG7+/9/2ezabTc0IARCqoWJl45v06WGZtdata-src5iICmhdlfkqj5dZ6iT58fkun/SMc+kbzhfc
                        ...
                        <g id="sylhet">
                        <a href="http://dainiksampan.com/sylhet" xlink:href="http://dainiksampan.com/sylhet">
                        ...
                        <g id="khulna">
                        <a href="http://dainiksampan.com/khulna" xlink:href="http://dainiksampan.com/khulna">
                        ...
                        <g id="dhaka">
                        <a href="https://dainiksampan.com/dhaka" xlink:href="https://dainiksampan.com/dhaka">
                        ...
                        <g id="mymensingh">
                        <a href="https://dainiksampan.com/mymensingh" xlink:href="https://dainiksampan.com/mymensingh">
                        ...
                        <g id="rajshahi">
                        <a href="https://dainiksampan.com/rajshahi" xlink:href="https://dainiksampan.com/rajshahi">
                        ...
                        <g id="borishal">
                        <a href="https://dainiksampan.com/barishal" xlink:href="https://dainiksampan.com/barishal">
                        ...
                        <g id="chittagong">
                        <a href="http://dainiksampan.com/area" xlink:href="http://dainiksampan.com/area">
        ...
        <section class="cat-two">
            <div class="cat-two-area ">
                <!-- News Cards (Grid) -->
                <div class="row pb-3">
                   <div class="col-md-9">
                    @if ($countrywideData->category && $countrywideData->posts->isNotEmpty())
                        <div class="opinion-section">
                            <h4><a href="#"> {{ $countrywideData->category->name }} </a></h4>
                        </div>
                        @php
                            $firstThreePosts = $countrywideData->posts->take(3);
                            $nextFourPosts = $countrywideData->posts->skip(3)->take(4);
                        @endphp
                            ...
                            <div class="col-sm-6 col-6 col-md-4 border-right">
                                <a href="{{ $post->url }}" class="text-decoration-none text-dark">
                                    <div class="card border-0 h-100">
                                        <div class="cate-two-zoom">
                                            <img src="{{ RvMedia::getImageUrl($post->image, 'medium', false, RvMedia::getDefaultImage()) }}" class="card-img-top fixed-img-two " alt="{{ $firstPost->name }}">
                                        </div>
                                        <div class="card-body p-2">
                                            <h4 class="news-title-two">{{ $post->name }}</h4>
                                        </div>
                        ...
                        <div class="row mt-3 mini-card-0">
                              @foreach ($nextFourPosts as $post)
                            <div class="col-sm-6 col-6 col-md-3 border-right">
                                <a href="{{ $post->url }}" class="text-decoration-none text-dark">
                                    <div class="card border-0 h-100">
                                        <div class="cate-two-zoom">
        ...
        <section class="cat-four">
            <div class="row">
                <!-- left col-9 -->
                <div class="col-lg-9">
                    @if ($politicsData->category && $politicsData->posts->isNotEmpty())
                    <div class="opinion-section">
                        <h4><a href="{{ $politicsData->category->url }}"> {{ $politicsData->category->name }} </a></h4>
                    </div>
                     <div class="row">
                         @php $firstPost = $politicsData->posts->first(); @endphp
                            @if ($firstPost)
                            <div class="col-lg-6">
                                <div class="bg-cat-news card mb-3">
                                    <a href="#">
                        ...
                        <!-- Middle Column (Secondary Stories) -->
                        <div class="col-lg-6">
                             @foreach ($politicsData->posts->skip(1) as $post)
                            <div class="d-flex flex-column gap-3 list-card">
                                <!-- Horizontal News Card 1 -->
                                <div class="card news-card border-bottom pb-3 img-hover-zoom">
                                    <div class="card-body d-flex gap-3 align-items-center">
                ...
                <!-- right Side -->
                 <div class="col-lg-3">
                   <div class="box-title"> <h4>আর্কাইভ</h3> </div>
                     <div class="box-content text-center py-3">
                        <img src="img/ads3.png" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="cat-four">
            <div class="row">
                <!-- left col-9 -->
                <div class="col-lg-9">
                    @if ($sportsData->category && $sportsData->posts->isNotEmpty())
                        <div class="opinion-section">
                            <h4><a href="#">{{ $sportsData->category->name ?? 'বিনোদন' }}</a></h4>
                        </div>
                        @php
                            $firstPost = $sportsData->posts->first();
                            $middlePosts = $sportsData->posts->skip(1)->take(4);
                        @endphp
                        <div class="row">
                            {{-- প্রথম নিউজ (বড়) --}}
                            <div class="col-lg-6">
                                        ...
                                        <a href="{{ $firstPost->url }}" class="text-decoration-none text-dark">
                                            <div class="cate-two-zoom5">
                                                <img class="img-fluid w-100" 
                                                    src="{{ RvMedia::getImageUrl($firstPost->image, 'large', false, RvMedia::getDefaultImage()) }}" 
                                                    alt="{{ $firstPost->name }}">
                                            </div>
                                            <h4 class="pt-3 comtitle">{{ $firstPost->name }}</h4>
                                            @if ($firstPost->description)
                                                <p>{{ Str::limit(strip_tags($firstPost->description), 150) }}</p>
                                            @endif
                                        </a>
                                    </div>
                                @endif
                                                    ...
                                                    <div class="card border-0 h-100">
                                                        <div class="cate-two-zoom">
                                                            <img src="{{ RvMedia::getImageUrl($post->image, 'medium', false, RvMedia::getDefaultImage()) }}" 
                                                                class="card-img-top fixed-img-two" 
                                                                alt="{{ $post->name }}" 
                                                                style="height: 150px; object-fit: cover;">
                                                        </div>
                                                        <div class="card-body p-2">
                                                            <h4 class="news-title-two">{{ Str::limit($post->name, 60) }}</h4>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                ...
                <!-- right Side -->
                <div class="col-lg-3">
                    @if ($simpleOneData->category && $simpleOneData->posts->isNotEmpty())
                        <div class="opinion-section">
                            <h4>
                                <a href="{{ $simpleOneData->category->url }}">
                                    {{ $simpleOneData->category->name }}
                                </a>
                            </h4>
                        </div>
                        ...
                        @php
                            // প্রথম নিউজ
                            $firstPost = $simpleOneData->posts->first();
                            // পরের ২টা নিউজ
                            $otherPosts = $simpleOneData->posts->skip(1)->take(2);
                        @endphp

                        <div class="right-news-list">
                            <div class="list-news-grid">
                                {{-- প্রথম নিউজ --}}
                                @if ($firstPost)
                                    <a href="{{ $firstPost->url }}" class="text-decoration-none text-dark">
                                        <div class="card border-bottom h-100">
                                            <div class="cate-two-zoom">
                                                <img src="{{ RvMedia::getImageUrl($firstPost->image, 'medium', false, RvMedia::getDefaultImage()) }}" 
                                                    class="card-img-top fixed-img-two" 
                                                    alt="{{ $firstPost->name }}">
                                            </div>
                                            <div class="card-body p-2">
                                                <h4 class="news-title-two fw-bold">
                                                    <span class="text-danger">
                                                        {{ $simpleOneData->category->name }}
                                                    </span>
                                                    {{ Str::limit($firstPost->name, 70) }}
                                                </h4>
                                            </div>
                                        </div>
                                    </a>
        ...
        <section class="cat-four">
            <div class="row">
                <!-- left col-9 -->
                <div class="col-lg-9">
                    @if ($entertainmentData->category && $entertainmentData->posts->isNotEmpty())
                        <div class="opinion-section">
                            <h4>
                                <a href="{{ $entertainmentData->category->url }}">
                                    {{ $entertainmentData->category->name }}
                                </a>
                            </h4>
                        </div>

                        @php
                            // মোট নিউজগুলো আলাদা ভাগ করা
                            $leftPosts = $entertainmentData->posts->take(2); // প্রথম ২টা (বামে)
                            $middlePost = $entertainmentData->posts->skip(2)->take(1)->first(); // মাঝখানে ১টা
                            $rightPosts = $entertainmentData->posts->skip(3)->take(2); // ডানে ২টা
                        @endphp
                        ...
                        <div class="row">
                                        ...
                                        <a href="{{ $post->url }}" class="text-decoration-none text-dark">
                                            <div class="card border-0 h-100">
                                                ...
                                                <div class="card-body pt-2 pb-2">
                                                    <h4 class="news-title-two">{{ Str::limit($post->name, 70) }}</h4>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                @if ($middlePost)
                                    <div class="bg-cat-news card mb-3">
                                        <a href="{{ $middlePost->url }}" class="text-decoration-none text-dark">
                                            <div class="cate-two-zoom5">
                                                <img class="img-fluid w-100" 
                                                    src="{{ RvMedia::getImageUrl($middlePost->image, 'large', false, RvMedia::getDefaultImage()) }}" 
                                                    alt="{{ $middlePost->name }}">
                                            </div>
                                            <h4 class="pt-3 comtitle">{{ $middlePost->name }}</h4>
                                            @if ($middlePost->description)
                                                <p>{{ Str::limit(strip_tags($middlePost->description), 150) }}</p>
                                            @endif
                                        </a>
                                    </div>
                                @endif
                ...
                <!-- right Side -->
                  <div class="col-lg-3">
                    @if ($simpleTwoData->category && $simpleTwoData->posts->isNotEmpty())
                        <div class="opinion-section">
                            <h4>
                                <a href="{{ $simpleOneData->category->url }}">
                                    {{ $simpleOneData->category->name }}
                        ...
                        @php
                            // প্রথম নিউজ
                            $firstPost = $simpleTwoData->posts->first();
                            // পরের ২টা নিউজ
                            $otherPosts = $simpleTwoData->posts->skip(1)->take(2);
                        @endphp
        ...
        <!-- news 0ne-two-three -->
        <section class="cat-four mt-3">
            <div class="row">
                <!-- left col-9 -->
                <div class="col-lg-6 md-divider">
                    @if ($hillData->category && $hillData->posts->isNotEmpty())
                        <div class="opinion-section">
                            <h4>
                                <a href="{{ $hillData->category->url }}">
                                    {{ $hillData->category->name }}
                                </a>
                            </h4>
                        </div>
                        ...
                        @php
                            // প্রথম নিউজ (বড়)
                            $firstPost = $hillData->posts->first();
                            // পরের ৪টা নিউজ (ছোট)
                            $otherPosts = $hillData->posts->skip(1)->take(4);
                        @endphp
                ...
                <!-- right Side -->
                <div class="col-lg-6 md-divider">
                    @if ($businessData->category && $businessData->posts->isNotEmpty())
                        <div class="opinion-section">
                            <h4>
                                <a href="{{ $businessData->category->url }}">
                        ...
                        @php
                            // প্রথম নিউজ (বড়)
                            $firstPost = $businessData->posts->first();
                            // পরের ৪টা নিউজ (ছোট)
                            $otherPosts = $businessData->posts->skip(1)->take(4);
                        @endphp
       ...
       <section class="cat-two">
            <div class="cat-two-area my-4">
                @if ($opinionData->category && $opinionData->posts->isNotEmpty())
                    <div class="opinion-section mt-3">
                        <h4>
                            <a href="{{ $opinionData->category->url }}">
                                {{ $opinionData->category->name }}
                            </a>
                        </h4>
                    </div>

                    <div class="row g-4 mt-3 pb-3" style="background-color: #eee; margin: 0;">
                        @foreach ($opinionData->posts->take(8) as $post)
                            <div class="col-sm-6 col-6 col-md-3">
                                <a href="{{ $post->url }}" class="text-decoration-none text-dark">
                                    <div class="card border-x h-100">
                                        <div class="cate-two-zoom">
                                            <img src="{{ RvMedia::getImageUrl($post->image, 'medium', false, RvMedia::getDefaultImage()) }}"
                                                class="card-img-top fixed-img-two"
                                                alt="{{ $post->name }}">
        ...
        <section>
            <div class="row">
                @if ($educationData->category && $educationData->posts->isNotEmpty())
                <div class="col-md-3">
                <div class="mt-3">
                    <div class="opinion-section">
                        <h4>
                            <a href="{{ $educationData->category->url }}">
                                {{ $educationData->category->name }}
                            </a>
                        </h4>
                    </div>
                </div>
                ...
                @php
                    $firstPost = $educationData->posts->first();      // বড় নিউজ
                    $otherPosts = $educationData->posts->skip(1)->take(2); // ২টা ছোট শিরোনাম নিউজ
                @endphp
        ...
        <div class="list-news-grid">
            ...
            {{-- ২টা ছোট শিরোনাম নিউজ --}}
            <ul class="list-unstyled mt-2">
                @foreach ($otherPosts as $post)
                    <li class="sidebar-post border-bottom pb-2 mb-2">
                        <a href="{{ $post->url }}">
...
@endif
                ...
                <div class="col-md-3">
                    <div class=" mt-3">
                         <div class="opinion-section"><h4><a href="#"> চিকিৎসা </a></h4> </div>
                    </div>
                    <!-- News Item -->
                    <div class="list-news-grid">
                        <a href="#" class="text-decoration-none text-dark">
                            <div class="card border-bottom h-100">
                                <div class="cate-two-zoom">
                                    <img src="img/news1.jpg" class="card-img-top fixed-img-two " alt="News 1">
                                </div>
                                <div class="card-body p-2">
                                    <h4 class="news-title-two fw-bold">নাশকতার পরিকল্পনায় ইউপি চেয়ারম্যান গ্রেপ্তার</h4>
                                </div>
                            </div>
                        </a>
                        <ul class="list-unstyled mt-2">
                            <li class="sidebar-post border-bottom pb-2 mb-2"> <a href="#">নির্ধারিত সময়ের মধ্যেই সরকারকে পিআর পদ্ধতিতে নির্বাচন দিতে হবে : বুলবুল</a> </li>
                            <li class="sidebar-post border-bottom pb-2 mb-2"> <a href="#">জুলাই বিপ্লব অর্থবহ করতে গণহত্যার বিচার হতে হবে : সেলিম উদ্দিন</a> </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class=" mt-3">
                        <div class="opinion-section"><h4><a href="#"> সোসাইল মিডিয়া </a></h4> </div>
                    </div>
                    <!-- News Item -->
                    <div class="list-news-grid">
                        <a href="#" class="text-decoration-none text-dark">
                ...
                <div class="col-md-3">
                    <div class=" mt-3">
                        <div class="opinion-section"><h4><a href="#"> ভ্রমণ </a></h4> </div>
                    </div>
                    <!-- News Item -->
                    <div class="list-news-grid">
                        <a href="#" class="text-decoration-none text-dark">
